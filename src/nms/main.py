...
from models import UserRegistrationRequest, RegistrationResponse, OrderCreateRequest, OrderResponse
...
def mock_db_save_order(user_id: int, tariff: str):
    ...
    print(f"[STUB-DB] Order #{fake_order_id} created for User {user_id} (Tariff: {tariff})")
