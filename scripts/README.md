...
- `test_orders.py` - Интерактивный скрипт для работы с заказами (CRUD операции)
...
Интерактивный скрипт для тестирования таблицы `orders`:

```bash
poetry run python scripts/test_orders.py
```
