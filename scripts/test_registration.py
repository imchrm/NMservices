...
# Конфигурация
API_BASE_URL = "http://192.168.1.191:8000"  # IP вашего сервера в локальной сети
...
async def test_user_registration(
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        try:
            ...
            print("   Убедитесь, что:")
            print("   1. Сервер запущен (uvicorn)")
            print("   2. IP адрес правильный")
            print("   3. Порт 8000 открыт в файерволе")
            print(f"   Ошибка: {e}")
            return None
            ...
            print(f"❌ Неожиданная ошибка HTTP: {e}")
            return None
