...
*   **Пользователи:** `GET/POST /admin/users`, `GET/DELETE /admin/users/{id}`, `GET /admin/users/{id}/orders`
...
poetry run python scripts/test_admin_api.py http://localhost:8000 admin_secret

# Bash-версия (Linux/macOS)
./scripts/test_admin_api.sh http://localhost:8000 admin_secret
```
